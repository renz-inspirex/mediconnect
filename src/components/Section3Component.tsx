      ...
      <section className="flex w-[100%] h-[815px] flex-col" id="section3">
        <div className="flex mt-[60px] justify-around items-center gap-52 h-full">
           <div className="w-[710px] h-[384px] z-10">
                ...
                <p className={`${poppinesParagraph400.className} text-base text-ash m-6 leading-[24px]`}>Medconnect addresses the need for accessible and reliable medical information in a world where health decisions are becoming increasingly complex. By offering a user-friendly platform for symptom analysis, appointment scheduling, and medication availability</p>
           </div>
           <div></div>
        </div>
      </section>
