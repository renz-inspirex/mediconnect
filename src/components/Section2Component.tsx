      ...
      <section className="bg-secondary flex w-[100%] h-[704px] flex-col">
        <div className="flex mt-[60px] justify-center items-center gap-52 h-full">
           <div className="w-[710px] h-[384px]">
                ...
                <p className="text-base text-white m-6 leading-[24px] max-w-[428px]">Scheduling appointments with doctors has never been easier. Take control of your healthcare journey and never miss another important appointment.</p>
                <SearchBar/>
           </div>
